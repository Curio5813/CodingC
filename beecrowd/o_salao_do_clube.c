...
int main(){
	...
	long long int bool1, bool2, bool3, bool4, n1, n2;
	long long int n_tabuas1, n_tabuas2, menor1, menor2, aux1, aux2;
	long long int *tabuas, *idx1, *idx2, resp;
	long long int largura_tabua;
	...
	while(largura != 0 && comprimento != 0){
		...
		cont1 = 0;
		cont2 = 0;
		menor1 = 1000000000000000000;
		menor2 = 1000000000000000000;
		bool1 = 1;
		bool2 = 1;
		bool3 = 1;
		bool4 = 1;
		...
		idx1 = (long long int*)malloc(1000000 * sizeof(long long int));
		idx2 = (long long int*)malloc(1000000 * sizeof(long long int));
		...
		if(menor1 == menor2 && menor2 == 1000000000000000000){
			printf("impossivel\n");
		}
		else{
			if(menor1 <= menor2){
